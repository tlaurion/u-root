...
//go:build amd64 //go:build amd64 && !tinygo && !tinygo.enable//go:build amd64 && !tinygo && !tinygo.enable !tinygo //go:build amd64 && !tinygo && !tinygo.enable//go:build amd64 && !tinygo && !tinygo.enable !tinygo.enable
